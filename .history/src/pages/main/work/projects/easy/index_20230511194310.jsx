  ...
  return (
    <div>
      <div onClick={handleVideoClick} className="individual-wrapper">
        ...
        <a href="https://github.com/Leoka2000/front-end-ScholarSearch" className="github-link">
          <AiFillGithub />
          <p id="hover">- Front end source</p>
        </a>
        <a href="https://github.com/Leoka2000/back-end-laravel" className="github-link">
          <AiFillGithub />
