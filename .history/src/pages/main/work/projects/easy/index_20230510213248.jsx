...
const index = () => {
  return (
    <a href='https://beamish-babka-ea7d99.netlify.app/' className='individual-wrapper'>
      ...
      <h1>ScholarSearch</h1>
      <p>This is a full stack application that consumes a REST API. ScholarSearch was made for EasyTramitt, a startup that help students get scholarhips abroad.</p>
